...
export declare function hasOptionalFields(s: string): s is (keyof typeof optionalFields);
export declare function hasMandatoryFields(s: string): s is (keyof typeof mandatoryFields);
